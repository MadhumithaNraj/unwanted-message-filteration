<%@ Page Language="VB" AutoEventWireup="false" CodeFile="blogposting2.aspx.vb" Inherits="blogposting2" %>
                                            ...
                                            <tr>
                                                <td class="style83" valign="top">
                                                    <table style="width:100%;">
                                                        ...
                                                        <tr>
                                                                                                                        <td class="style97"><span lang="en-us">Blog </span>:</td>
...
<tr>
                                                            <td class="style97"><span lang="en-us">Friend</span>:</td>
                                                            <td class="style98">                                                              
                                                                <asp:DropDownList ID="ddlFrnd" runat="server" CssClass="auto-style1" Font-Bold="True" Height="50px" Width="285px">
                                                                </asp:DropDownList>
                                                            </td>
                                                            <td class="style88">
                                                                &nbsp;</td>
                                                        ...
                                                        <tr>
                                                            <td class="style75">
                                                                &nbsp;</td>
                                                            <td class="style98">
                                                            <asp:Button id="BT_Send" runat="server" Text="Post into Wall" Width="140px" 
