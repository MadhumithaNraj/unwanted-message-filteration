...
Partial Class frmBadWords
    ...
    Protected Sub btnUpload_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnUpload.Click
        Try
            ...
            filePath = Server.MapPath(".") & "\database\Files\badWords.txt"
            ...
            While sw.Peek <> -1
                ...
                If input.Trim <> "" Then
                    ...
                    qry = "delete from tblBadWords where badWord   = '" & objX.FormatText(input.Trim) & "'"
                    objX.exeQuery(qry)

                    qry = "insert into  tblBadWords values ('" & objX.FormatText(input.Trim) & "')"
                    objX.exeQuery(qry)
                End If
