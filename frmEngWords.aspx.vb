...
Partial Class frmEngWords
    ...
    Protected Sub btnUpload_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnUpload.Click
        Try
            ...
            filePath = Server.MapPath(".") & "\database\Files\englishwords.txt"
            ...
            While sw.Peek <> -1
                ...
                If input.Trim <> "" Then
                    ...
                    qry = "delete from tblEngWords where engWord = '" & objX.FormatText(input.Trim) & "'"
                    objX.exeQuery(qry)

                    qry = "insert into  tblEngWords values ('" & objX.FormatText(input.Trim) & "')"
                    objX.exeQuery(qry)
                End If
