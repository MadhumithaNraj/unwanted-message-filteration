...
Partial Class frmSplChar
    ...
    Protected Sub btnUpload_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnUpload.Click
        Try
            ...
            filePath = Server.MapPath(".") & "\database\Files\SplChar.txt"
            ...
            While sw.Peek <> -1
                ...
                If input.Trim <> "" Then
                    ...
                    qry = "delete from tblSplChar where SpecialChar = '" & objX.FormatText(input.Trim) & "'"
                    objX.exeQuery(qry)

                    qry = "insert into  tblSplChar values ('" & objX.FormatText(input.Trim) & "')"
                    objX.exeQuery(qry)
                End If
        ...
        Finally
            fillBlog()
            MsgBox("Special Characters updated...")
    ...
    Sub fillBlog()
        Try
            ...
            qry = "select *  from  tblSplChar order by SpecialChar"
